...
import (
	...
	corev1client "ck-kube/kubernetes/client-go/kubernetes/typed/core/v1"
	"ck-kube/kubernetes/client-go/rest"
	"ck-kube/kubernetes/client-go/tools/reference"
	utilcsr "ck-kube/kubernetes/client-go/util/certificate/csr"
	"ck-kube/kubernetes/kubectl/pkg/scheme"
	"ck-kube/kubernetes/kubectl/pkg/util/certificate"
	deploymentutil "ck-kube/kubernetes/kubectl/pkg/util/deployment"
	"ck-kube/kubernetes/kubectl/pkg/util/event"
	"ck-kube/kubernetes/kubectl/pkg/util/fieldpath"
	"ck-kube/kubernetes/kubectl/pkg/util/qos"
	"ck-kube/kubernetes/kubectl/pkg/util/rbac"
	resourcehelper "ck-kube/kubernetes/kubectl/pkg/util/resource"
	"ck-kube/kubernetes/kubectl/pkg/util/slice"
	storageutil "ck-kube/kubernetes/kubectl/pkg/util/storage"
