...
import (
	admissionv1 "github.com/fslqd/ck-kube/kubernetes/api/admission/v1"
	admissionv1beta1 "github.com/fslqd/ck-kube/kubernetes/api/admission/v1beta1"
...
// Register all groups in the kubectl's registry, but no componentconfig group since it's not in github.com/fslqd/ck-kube/kubernetes/api
// The code in this file mostly duplicate the install under github.com/fslqd/ck-kube/kubernetes/kubernetes/pkg/api and github.com/fslqd/ck-kube/kubernetes/kubernetes/pkg/apis,
