...
func (in *CSIStorageCapacity) APILifecycleReplacement() schema.GroupVersionKind {
	return schema.GroupVersionKind{Group: "storage.ck-kube/kubernetes", Version: "v1beta1", Kind: "CSIStorageCapacity"}
}
...
func (in *CSIStorageCapacityList) APILifecycleReplacement() schema.GroupVersionKind {
	return schema.GroupVersionKind{Group: "storage.ck-kube/kubernetes", Version: "v1beta1", Kind: "CSIStorageCapacityList"}
}
