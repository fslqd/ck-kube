...
func (in *CSIDriver) APILifecycleReplacement() schema.GroupVersionKind {
	return schema.GroupVersionKind{Group: "storage.github.com/fslqd/ck-kube/kubernetes", Version: "v1", Kind: "CSIDriver"}
}
...
func (in *CSIDriverList) APILifecycleReplacement() schema.GroupVersionKind {
	return schema.GroupVersionKind{Group: "storage.github.com/fslqd/ck-kube/kubernetes", Version: "v1", Kind: "CSIDriverList"}
}
...
func (in *CSINode) APILifecycleReplacement() schema.GroupVersionKind {
	return schema.GroupVersionKind{Group: "storage.github.com/fslqd/ck-kube/kubernetes", Version: "v1", Kind: "CSINode"}
}
...
func (in *CSIStorageCapacity) APILifecycleReplacement() schema.GroupVersionKind {
	return schema.GroupVersionKind{Group: "storage.github.com/fslqd/ck-kube/kubernetes", Version: "v1", Kind: "CSIStorageCapacity"}
}
...
func (in *CSIStorageCapacityList) APILifecycleReplacement() schema.GroupVersionKind {
	return schema.GroupVersionKind{Group: "storage.github.com/fslqd/ck-kube/kubernetes", Version: "v1", Kind: "CSIStorageCapacityList"}
}
...
func (in *StorageClass) APILifecycleReplacement() schema.GroupVersionKind {
	return schema.GroupVersionKind{Group: "storage.github.com/fslqd/ck-kube/kubernetes", Version: "v1", Kind: "StorageClass"}
}
...
func (in *StorageClassList) APILifecycleReplacement() schema.GroupVersionKind {
	return schema.GroupVersionKind{Group: "storage.github.com/fslqd/ck-kube/kubernetes", Version: "v1", Kind: "StorageClassList"}
}
...
func (in *VolumeAttachment) APILifecycleReplacement() schema.GroupVersionKind {
	return schema.GroupVersionKind{Group: "storage.github.com/fslqd/ck-kube/kubernetes", Version: "v1", Kind: "VolumeAttachment"}
}
...
func (in *VolumeAttachmentList) APILifecycleReplacement() schema.GroupVersionKind {
	return schema.GroupVersionKind{Group: "storage.github.com/fslqd/ck-kube/kubernetes", Version: "v1", Kind: "VolumeAttachmentList"}
}
