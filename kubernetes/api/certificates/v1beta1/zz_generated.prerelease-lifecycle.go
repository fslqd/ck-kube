...
func (in *CertificateSigningRequest) APILifecycleReplacement() schema.GroupVersionKind {
	return schema.GroupVersionKind{Group: "certificates.ck-kube/kubernetes", Version: "v1", Kind: "CertificateSigningRequest"}
}
...
func (in *CertificateSigningRequestList) APILifecycleReplacement() schema.GroupVersionKind {
	return schema.GroupVersionKind{Group: "certificates.ck-kube/kubernetes", Version: "v1", Kind: "CertificateSigningRequestList"}
}
