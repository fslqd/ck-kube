...
func (in *LocalSubjectAccessReview) APILifecycleReplacement() schema.GroupVersionKind {
	return schema.GroupVersionKind{Group: "authorization.github.com/fslqd/ck-kube/kubernetes", Version: "v1", Kind: "LocalSubjectAccessReview"}
}
...
func (in *SelfSubjectAccessReview) APILifecycleReplacement() schema.GroupVersionKind {
	return schema.GroupVersionKind{Group: "authorization.github.com/fslqd/ck-kube/kubernetes", Version: "v1", Kind: "SelfSubjectAccessReview"}
}
...
func (in *SelfSubjectRulesReview) APILifecycleReplacement() schema.GroupVersionKind {
	return schema.GroupVersionKind{Group: "authorization.github.com/fslqd/ck-kube/kubernetes", Version: "v1", Kind: "SelfSubjectRulesReview"}
}
...
func (in *SubjectAccessReview) APILifecycleReplacement() schema.GroupVersionKind {
	return schema.GroupVersionKind{Group: "authorization.github.com/fslqd/ck-kube/kubernetes", Version: "v1", Kind: "SubjectAccessReview"}
}
