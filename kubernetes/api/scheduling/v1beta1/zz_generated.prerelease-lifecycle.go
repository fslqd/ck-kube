...
func (in *PriorityClass) APILifecycleReplacement() schema.GroupVersionKind {
	return schema.GroupVersionKind{Group: "scheduling.ck-kube/kubernetes", Version: "v1", Kind: "PriorityClass"}
}
...
func (in *PriorityClassList) APILifecycleReplacement() schema.GroupVersionKind {
	return schema.GroupVersionKind{Group: "scheduling.ck-kube/kubernetes", Version: "v1", Kind: "PriorityClassList"}
}
