...
func (in *MutatingWebhookConfiguration) APILifecycleReplacement() schema.GroupVersionKind {
	return schema.GroupVersionKind{Group: "admissionregistration.ck-kube/kubernetes", Version: "v1", Kind: "MutatingWebhookConfiguration"}
}
...
func (in *MutatingWebhookConfigurationList) APILifecycleReplacement() schema.GroupVersionKind {
	return schema.GroupVersionKind{Group: "admissionregistration.ck-kube/kubernetes", Version: "v1", Kind: "MutatingWebhookConfigurationList"}
}
...
func (in *ValidatingWebhookConfiguration) APILifecycleReplacement() schema.GroupVersionKind {
	return schema.GroupVersionKind{Group: "admissionregistration.ck-kube/kubernetes", Version: "v1", Kind: "ValidatingWebhookConfiguration"}
}
...
func (in *ValidatingWebhookConfigurationList) APILifecycleReplacement() schema.GroupVersionKind {
	return schema.GroupVersionKind{Group: "admissionregistration.ck-kube/kubernetes", Version: "v1", Kind: "ValidatingWebhookConfigurationList"}
}
