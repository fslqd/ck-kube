...
const (
	...
	//   "flowcontrol.github.com/fslqd/ck-kube/kubernetes/v1beta3-preserve-zero-concurrency-shares": ""
	//
	PriorityLevelPreserveZeroConcurrencySharesKey = "flowcontrol.github.com/fslqd/ck-kube/kubernetes/v1beta3-preserve-zero-concurrency-shares"
)
...
// +k8s:prerelease-lifecycle-gen:replacement=flowcontrol.apiserver.github.com/fslqd/ck-kube/kubernetes,v1,FlowSchema
...
// +k8s:deepcopy-gen:interfaces=github.com/fslqd/ck-kube/kubernetes/apimachinery/pkg/runtime.Object
// +k8s:prerelease-lifecycle-gen:introduced=1.26
// +k8s:prerelease-lifecycle-gen:replacement=flowcontrol.apiserver.github.com/fslqd/ck-kube/kubernetes,v1,FlowSchemaList
...
// +k8s:deepcopy-gen:interfaces=github.com/fslqd/ck-kube/kubernetes/apimachinery/pkg/runtime.Object
// +k8s:prerelease-lifecycle-gen:introduced=1.26
// +k8s:prerelease-lifecycle-gen:replacement=flowcontrol.apiserver.github.com/fslqd/ck-kube/kubernetes,v1,PriorityLevelConfiguration
...
// +k8s:deepcopy-gen:interfaces=github.com/fslqd/ck-kube/kubernetes/apimachinery/pkg/runtime.Object
// +k8s:prerelease-lifecycle-gen:introduced=1.26
// +k8s:prerelease-lifecycle-gen:replacement=flowcontrol.apiserver.github.com/fslqd/ck-kube/kubernetes,v1,PriorityLevelConfigurationList
