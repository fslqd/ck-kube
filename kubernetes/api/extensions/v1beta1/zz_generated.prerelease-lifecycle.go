...
func (in *Ingress) APILifecycleReplacement() schema.GroupVersionKind {
	return schema.GroupVersionKind{Group: "networking.ck-kube/kubernetes", Version: "v1", Kind: "Ingress"}
}
...
func (in *IngressList) APILifecycleReplacement() schema.GroupVersionKind {
	return schema.GroupVersionKind{Group: "networking.ck-kube/kubernetes", Version: "v1", Kind: "IngressList"}
}
...
func (in *NetworkPolicy) APILifecycleReplacement() schema.GroupVersionKind {
	return schema.GroupVersionKind{Group: "networking.ck-kube/kubernetes", Version: "v1", Kind: "NetworkPolicy"}
}
...
func (in *NetworkPolicyList) APILifecycleReplacement() schema.GroupVersionKind {
	return schema.GroupVersionKind{Group: "networking.ck-kube/kubernetes", Version: "v1", Kind: "NetworkPolicyList"}
}
