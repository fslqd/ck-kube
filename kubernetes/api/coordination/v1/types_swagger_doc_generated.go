...
var map_Lease = map[string]string{
	...
	"spec":     "spec contains the specification of the Lease. More info: https://git.ck-kube/kubernetes/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status",
}
