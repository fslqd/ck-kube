...
func (in *Lease) APILifecycleReplacement() schema.GroupVersionKind {
	return schema.GroupVersionKind{Group: "coordination.ck-kube/kubernetes", Version: "v1", Kind: "Lease"}
}
...
func (in *LeaseList) APILifecycleReplacement() schema.GroupVersionKind {
	return schema.GroupVersionKind{Group: "coordination.ck-kube/kubernetes", Version: "v1", Kind: "LeaseList"}
}
