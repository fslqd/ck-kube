...
// +genclient:method=ApplyScale,verb=apply,subresource=scale,input=github.com/fslqd/ck-kube/kubernetes/api/autoscaling/v1.Scale,result=github.com/fslqd/ck-kube/kubernetes/api/autoscaling/v1.Scale
