...
// +genclient:method=ApplyScale,verb=apply,subresource=scale,input=ck-kube/kubernetes/api/autoscaling/v1.Scale,result=ck-kube/kubernetes/api/autoscaling/v1.Scale
