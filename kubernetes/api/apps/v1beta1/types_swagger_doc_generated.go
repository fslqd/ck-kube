...
var map_Scale = map[string]string{
	...
	"status":   "status defines current status of the scale. More info: https://git.github.com/fslqd/ck-kube/kubernetes/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status. Read-only.",
}
