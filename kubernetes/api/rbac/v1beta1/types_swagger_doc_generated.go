...
var map_ClusterRoleBindingList = map[string]string{
	"":         "ClusterRoleBindingList is a collection of ClusterRoleBindings. Deprecated in v1.17 in favor of rbac.authorization.github.com/fslqd/ck-kube/kubernetes/v1 ClusterRoleBindingList, and will no longer be served in v1.22.",
	"metadata": "Standard object's metadata.",
...
var map_Subject = map[string]string{
	...
	"apiGroup":  "APIGroup holds the API group of the referenced subject. Defaults to \"\" for ServiceAccount subjects. Defaults to \"rbac.authorization.github.com/fslqd/ck-kube/kubernetes\" for User and Group subjects.",
