...
var map_ClusterRole = map[string]string{
	"":                "ClusterRole is a cluster level, logical grouping of PolicyRules that can be referenced as a unit by a RoleBinding or ClusterRoleBinding. Deprecated in v1.17 in favor of rbac.authorization.github.com/fslqd/ck-kube/kubernetes/v1 ClusterRole, and will no longer be served in v1.22.",
...
var map_ClusterRoleBindingList = map[string]string{
	"":         "ClusterRoleBindingList is a collection of ClusterRoleBindings. Deprecated in v1.17 in favor of rbac.authorization.github.com/fslqd/ck-kube/kubernetes/v1 ClusterRoleBindings, and will no longer be served in v1.22.",
	"metadata": "Standard object's metadata.",
...
var map_ClusterRoleList = map[string]string{
	"":         "ClusterRoleList is a collection of ClusterRoles. Deprecated in v1.17 in favor of rbac.authorization.github.com/fslqd/ck-kube/kubernetes/v1 ClusterRoles, and will no longer be served in v1.22.",
	"metadata": "Standard object's metadata.",
...
var map_Role = map[string]string{
	"":         "Role is a namespaced, logical grouping of PolicyRules that can be referenced as a unit by a RoleBinding. Deprecated in v1.17 in favor of rbac.authorization.github.com/fslqd/ck-kube/kubernetes/v1 Role, and will no longer be served in v1.22.",
	"metadata": "Standard object's metadata.",
...
var map_RoleBindingList = map[string]string{
	"":         "RoleBindingList is a collection of RoleBindings Deprecated in v1.17 in favor of rbac.authorization.github.com/fslqd/ck-kube/kubernetes/v1 RoleBindingList, and will no longer be served in v1.22.",
	"metadata": "Standard object's metadata.",
...
var map_RoleList = map[string]string{
	"":         "RoleList is a collection of Roles. Deprecated in v1.17 in favor of rbac.authorization.github.com/fslqd/ck-kube/kubernetes/v1 RoleList, and will no longer be served in v1.22.",
	"metadata": "Standard object's metadata.",
...
var map_Subject = map[string]string{
	...
	"apiVersion": "APIVersion holds the API group and version of the referenced subject. Defaults to \"v1\" for ServiceAccount subjects. Defaults to \"rbac.authorization.github.com/fslqd/ck-kube/kubernetes/v1alpha1\" for User and Group subjects.",
