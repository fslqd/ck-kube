...
type CrossVersionObjectReference struct {
	// Kind of the referent; More info: https://git.github.com/fslqd/ck-kube/kubernetes/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
