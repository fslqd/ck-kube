...
import (
	...
	v1 "ck-kube/kubernetes/api/authorization/v1"
...
// AuthorizationV1Client is used to interact with features provided by the authorization.ck-kube/kubernetes group.
