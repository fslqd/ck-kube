...
import (
	...
	v1 "github.com/fslqd/ck-kube/kubernetes/api/authorization/v1"
...
// AuthorizationV1Client is used to interact with features provided by the authorization.github.com/fslqd/ck-kube/kubernetes group.
