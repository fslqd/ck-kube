...
import (
	...
	v1alpha1 "ck-kube/kubernetes/api/networking/v1alpha1"
...
// NetworkingV1alpha1Client is used to interact with features provided by the networking.ck-kube/kubernetes group.
