...
import (
	...
	v1alpha1 "github.com/fslqd/ck-kube/kubernetes/api/networking/v1alpha1"
...
// NetworkingV1alpha1Client is used to interact with features provided by the networking.github.com/fslqd/ck-kube/kubernetes group.
