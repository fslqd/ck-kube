...
import (
	...
	v1beta1 "ck-kube/kubernetes/api/scheduling/v1beta1"
...
// SchedulingV1beta1Client is used to interact with features provided by the scheduling.ck-kube/kubernetes group.
