...
import (
	...
	v1 "github.com/fslqd/ck-kube/kubernetes/api/autoscaling/v1"
	...
	autoscalingv1 "github.com/fslqd/ck-kube/kubernetes/client-go/applyconfigurations/autoscaling/v1"
