...
import (
	...
	v1alpha1 "ck-kube/kubernetes/api/certificates/v1alpha1"
...
// CertificatesV1alpha1Client is used to interact with features provided by the certificates.ck-kube/kubernetes group.
