...
import (
	...
	v1beta1 "ck-kube/kubernetes/api/authentication/v1beta1"
...
// AuthenticationV1beta1Client is used to interact with features provided by the authentication.ck-kube/kubernetes group.
