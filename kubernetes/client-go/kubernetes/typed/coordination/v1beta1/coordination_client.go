...
import (
	...
	v1beta1 "ck-kube/kubernetes/api/coordination/v1beta1"
...
// CoordinationV1beta1Client is used to interact with features provided by the coordination.ck-kube/kubernetes group.
