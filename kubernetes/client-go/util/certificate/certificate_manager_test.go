...
import (
	...
	"ck-kube/kubernetes/client-go/kubernetes/fake"
	certificatesclient "ck-kube/kubernetes/client-go/kubernetes/typed/certificates/v1beta1"
	clienttesting "ck-kube/kubernetes/client-go/testing"
