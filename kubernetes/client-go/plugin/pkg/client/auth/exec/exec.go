...
import (
	...
	clientauthenticationv1 "ck-kube/kubernetes/client-go/pkg/apis/clientauthentication/v1"
	clientauthenticationv1beta1 "ck-kube/kubernetes/client-go/pkg/apis/clientauthentication/v1beta1"
